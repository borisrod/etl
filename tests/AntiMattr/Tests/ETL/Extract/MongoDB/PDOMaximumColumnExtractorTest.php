...
use AntiMattr\ETL\Extract\MongoDB\PDOMaximumColumnExtractor;
use AntiMattr\TestCase\AntiMattrTestCase;

class PDOMaximumColumnExtractorTest extends AntiMattrTestCase
{
    private $collection;
    ...
    protected function setUp()
    {
        ...
        $this->table = 'my_table';
        $this->extractor = new PDOMaximumColumnExtractor(
            $this->db,
            $this->collectionName,
            $this->field,
            $this->connection,
