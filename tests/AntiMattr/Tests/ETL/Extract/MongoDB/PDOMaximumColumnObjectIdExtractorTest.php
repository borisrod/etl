...
use AntiMattr\ETL\Extract\MongoDB\PDOMaximumColumnObjectIdExtractor;
use AntiMattr\TestCase\AntiMattrTestCase;

class PDOMaximumColumnObjectIdExtractorTest extends AntiMattrTestCase
{
    private $collection;
    ...
    protected function setUp()
    {
        ...
        $this->table = 'my_table';
        $this->extractor = new PDOMaximumColumnObjectIdExtractor(
            $this->db,
            $this->collectionName,
            $this->field,
            $this->connection,
